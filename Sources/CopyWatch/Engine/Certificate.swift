        ...
        <style>
          ...
          <div class="card">
            ...
            <div class="files-wrap" style="margin-top:10px"><table>
              <thead><tr><th>File</th><th class="num">Size</th><th>SHA-256</th><th>Status</th></tr></thead>
              <tbody>\(fileRows)</tbody>
            </table></div>
          </div>

          <p class="foot">Generated by CopyWatch. Every file above was copied and its SHA-256 checksum confirmed against the source.</p>
        </div></body></html>
        """
    }
}
